                        ...
                        <Row className="justify-content-center">
                            <Col md="8" lg="6" xl="5">
                                        ...
                                        <Row>
                                            <Col xs="7">
                                                <div className="text-primary p-4">
                                                    <h5 className="text-primary">Bloquear Pantalla</h5>
                                                    <p>Ingresa tu Contraseña para desbloquearla!</p>
                                                </div>
                                            </Col>
                                ...
                                <div className="mt-5 text-center">
                                    <p>No puedes desbloquearla ? ve a  <Link to="/login" className="font-weight-medium text-primary"> Ingresar </Link> </p>
                                    <p>© 2020 Tu-Ecommerce. Desarrollado <i className="mdi mdi-heart text-danger"></i> por Eserp Agency</p>
                                </div>
